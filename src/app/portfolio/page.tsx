    ...
    <PageShell>
      <Container className="mobile-page mobile-page-portfolio max-w-[108rem] px-5 pt-32 sm:px-8 sm:pt-36 lg:pt-40 xl:px-10">
        ...
        <section id="featured-work" className="scroll-mt-28 py-14 sm:py-16">
          <Reveal>
            <article className="mobile-image-card home-module-strong grid min-w-0 overflow-visible rounded-panel border-secondary/40 lg:min-h-[34rem] lg:grid-cols-[1.08fr_0.92fr]">
              <div className="mobile-image-card-media overflow-hidden rounded-t-[inherit] lg:rounded-l-[inherit] lg:rounded-tr-none">
                <PortfolioProjectVisual slug={featuredProject.slug} featured />
              </div>
              <div className="mobile-image-card-content flex min-w-0 flex-col justify-center p-7 sm:p-10 lg:p-12">
