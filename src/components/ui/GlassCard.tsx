...
export function GlassCard({
  ...
  return (
    <div
      className={cn(
        'group/card relative isolate min-w-0 overflow-visible rounded-card p-5 sm:p-6',
    ...
    >
      {hasSystemEffect ? (
        <div aria-hidden="true" className="pointer-events-none absolute inset-0 z-0 overflow-hidden rounded-[inherit]">
          <span
            className="absolute inset-0 opacity-0 transition-opacity duration-300 group-hover/card:opacity-100 group-focus-within/card:opacity-100"
          >
